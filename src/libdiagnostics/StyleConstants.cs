...
namespace libdiagnostics
{
    public static class StyleConstants
    {
        ...
        public static Style GetBrightStyle(IStylePalette Palette, string Name,
            Color ForegroundColor, params string[] Preferences)
        {
        ...
        public static Style GetDimStyle(IStylePalette Palette, string Name,
            Color ForegroundColor, params string[] Preferences)
        {
            if (Palette.IsNamedStyle(Name))
            {
